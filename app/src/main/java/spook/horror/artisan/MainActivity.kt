...
private fun LabScaffold() {
    ...
    var embedDex by remember { mutableStateOf(Dex2OatRunner.embedDexInVdex) }
            ...
            TopAppBar(
                ...
                actions = {
                    ...
                    DropdownMenu(
                        ...
                        DropdownMenuItem(
                            text = { Text("Force embed DEX") },
                            trailingIcon = { Text(if (embedDex) "On ✓" else "Off") },
                            onClick = {
                                embedDex = !embedDex
                                Dex2OatRunner.embedDexInVdex = embedDex
                            },
                        )
                        DropdownMenuItem(
                            text = { Text("About") },
